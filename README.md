...
This was our first assignment use Node.js. We had to use our new knowledge of taking commands from the command prompt, running it through API's, parsing the JSON, and displaying on the terminal.  

A lot of time was spent just figuring out how to use the API's.  The actual logic was fairly simple. There is no CSS or HTML, so this wasn't as time consuming as other assignments.
